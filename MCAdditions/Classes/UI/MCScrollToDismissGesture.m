...
#import "MCScrollToDismissGesture.h"

@interface MCScrollToDismissGesture () <UIGestureRecognizerDelegate>

@end

@implementation MCScrollToDismissGesture
...
- (instancetype)init {
    ...
    if (self) {
        self.direction = MCPanGestureRecognizerDirectionVertical;
